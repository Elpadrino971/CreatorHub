// Mock data for CreatorHub MVP - TypeScript version
...
export const MOCK_PLATFORMS: Record<string, Platform> = {
  youtube: {
    connected: true,
...
export const MOCK_YOUTUBE_STATS: YouTubeStats = {
  subscribers: 127500,
...
export const MOCK_TWITCH_STATS: TwitchStats = {
  followers: 45200,
  followersGrowth: 4.1,
  totalViews: 2340000,
...
export const MOCK_COMBINED_STATS: CombinedStats = {
...
const generateDailyData = (): DailyAnalytics[] => {
...
export const MOCK_TOP_YOUTUBE_VIDEOS: YouTubeVideo[] = [
  {
    id: 'yt1',
...
export const MOCK_TOP_TWITCH_STREAMS: TwitchStream[] = [
  {
    id: 'tw1',
