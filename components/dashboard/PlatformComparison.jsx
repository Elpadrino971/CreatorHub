...
function MetricRow({ label, youtube, twitch, format = 'number' }) {
...
export default function PlatformComparison({ youtubeStats, twitchStats }) {
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <MetricRow 
          label="Croissance (%)"
          youtube={youtubeStats?.subscribersGrowth || 0}
          twitch={twitchStats?.followersGrowth || 0}
        />
      </CardContent>
    </Card>
  )
